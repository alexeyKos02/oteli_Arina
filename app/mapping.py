...
# Строка "1A" (одиночное размещение). Формула шаблона считает лишь линейную сумму
# по Bed prices и НЕ воспроизводит надбавку за одноместное размещение, поэтому сюда
# пишем "Single net" из PDF поверх формулы (как в эталоне).
OFFSET_SINGLE_1A = 16
